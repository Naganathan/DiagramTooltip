...
window.sfBlazor.Diagram = function () {
  ...
  var diagram = {
    ...
    */
    ...
    updateInnerLayerSize: function updateInnerLayerSize(layerList, width, height, scrollValues, transform, patternSize, gridLinePathData, dotsGrid, lineAttributes, pathAttributes, rectAttributes, circleAttributes, id) {
      var bounds;
