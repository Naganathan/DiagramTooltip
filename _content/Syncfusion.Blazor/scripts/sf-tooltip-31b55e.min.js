  ...
  function () {
    ...
    SfTooltip.prototype.reposition = function (target) {
      ...
      if (this.popupObj) {
        ...
        var tooltipBounds = this.tooltipEle.getBoundingClientRect();
        console.log("Target=> X: " + bounds.left + " Y: " + bounds.top + " W:" + bounds.width + " H:" + bounds.height);
        console.log("Tooltip=> X: " + tooltipBounds.left + "Y: " + tooltipBounds.top + " W:" + tooltipBounds.width + " H:" + tooltipBounds.height);
